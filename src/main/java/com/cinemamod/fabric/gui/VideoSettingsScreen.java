...
public class VideoSettingsScreen extends Screen {
    ...
    protected void init() {
        ...
        addRenderableWidget(new Checkbox(method_31362() + 23, 110, 196, 20, Component.nullToEmpty("Mute video while alt-tabbed"),
            ...
            public void onPress() {
                super.onPress();
                CinemaModClient.getInstance().getVideoSettings().setMuteWhenAltTabbed(selected());
            }
        });
        addRenderableWidget(new Checkbox(method_31362() + 23, 142, 196, 20, Component.nullToEmpty("Hide crosshair while video playing"),
            ...
            public void onPress() {
                super.onPress();
                CinemaModClient.getInstance().getVideoSettings().setHideCrosshair(selected());
            }
        });
        addRenderableWidget(new Button(method_31362() + 23, 142 + 32, 196, 20,
                Component.nullToEmpty("Screen resolution: " + CinemaModClient.getInstance().getVideoSettings().getBrowserResolution() + "p"), button -> {
            CinemaModClient.getInstance().getVideoSettings().setNextBrowserResolution();
            button.setMessage(Component.nullToEmpty("Screen resolution: " + CinemaModClient.getInstance().getVideoSettings().getBrowserResolution() + "p"));
