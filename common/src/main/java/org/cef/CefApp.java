...
import com.cinemamod.common.CinemaMod;
...
public class CefApp extends CefAppHandlerAdapter {
    ...
    private final void initialize() {
        ...
        CinemaMod.LOGGER.info("initialize on " + Thread.currentThread() + " with library path " + jcefPath);
    ...
    protected final void handleBeforeTerminate() {
        CinemaMod.LOGGER.info("Cmd+Q termination request.");
